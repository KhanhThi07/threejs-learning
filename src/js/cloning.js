...
const stagkeyUrl = new URL("../assets/Stag.gltf", import.meta.url);
  ...
  if (!objectExist) {
    ...
    intersects.forEach(function (intersect) {
      if (intersect.object.name === "ground") {
        ...
        const mixer = new THREE.AnimationMixer(stagClone); //liên kết với bản sao đã tạo
...
// let mixer;
let stag;
let clips; //Lưu trữ các hoạt ảnh
assetLoader.load(
  stagkeyUrl.href,
  function (gltf) {
